...
public class SeeHistoryPage extends javax.swing.JPanel {
    ...
    public void populateValues() {
        ...
        switch (history.getStatus()) {
            case Submitted -> lblStatus.setText("Submitted");
            case Assigned -> lblStatus.setText("Assigned");
            case Approved -> lblStatus.setText("Approved");
            case InProgress -> lblStatus.setText("In Progress");
            default -> {
            }
        }
